...
Node::Node(int u, double flow, const std::shared_ptr<Node> &parent)
{
	value = u;
	children = 0;
	flow_to_parent = flow;
...
std::shared_ptr<Node> Trie::insert(int u, double flow, const std::shared_ptr<Node> &parent)
{
...
void Trie::insert(std::unique_ptr<Trie> &u, double flow, const std::shared_ptr<Node> &parent)
{
