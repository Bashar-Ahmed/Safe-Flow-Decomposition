...
Raw_Graph::Raw_Graph(const std::string& graph) : Graph(graph) {
...
void Raw_Graph::compute_safe(int u) {
...
void Raw_Graph::print_raw_decomposition() {
...
void Raw_Graph::topo_dfs(int v, std::vector<bool>& visited) {
    visited[v] = true;
